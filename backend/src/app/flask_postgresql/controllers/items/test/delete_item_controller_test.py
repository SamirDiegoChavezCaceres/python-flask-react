...
def test_delete_item_controller(monkeypatch, mocker, fixture_item_biscuit):
    ...
    mock_repository = mocker.patch(
        "src.app.flask_postgresql.controllers.items.delete_item_controller.\
...
DeleteItemUseCase"
    ...
    controller = DeleteItemController(logger_mock)
