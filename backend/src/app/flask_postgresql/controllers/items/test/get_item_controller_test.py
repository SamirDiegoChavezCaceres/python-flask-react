...
def test_get_item_controller(monkeypatch, mocker, fixture_item_biscuit):
    ...
    mock_repository = mocker.patch(
        "src.app.flask_postgresql.controllers.items.get_item_controller.\
...
GetItemUseCase"
    ...
    controller = GetItemController(logger_mock)
