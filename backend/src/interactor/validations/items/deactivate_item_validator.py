""" Defines the validator for the deactivate item input data.
"""
...
class DeactivateItemInputDtoValidator(BaseInputValidator):
    """ Validates the deactivate item input data.
