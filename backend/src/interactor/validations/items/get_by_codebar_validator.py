""" Defines the validator for the get item by codebar input data.
"""
...
class GetItemByCodebarInputDtoValidator(BaseInputValidator):
    """ Validates the get item by codebar input data.
